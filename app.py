...
# --- Active model roster (only confirmed working models) ---
GROQ_MODEL_IDS = {
...
MODEL_DESCRIPTIONS = {
    "Groq - Llama 3.3 70B (Free)": "🦙 **Llama 3.3 70B** — Meta open-source. Most reliable and battle-tested on Groq. Excellent at following complex structured prompts.",
    "Groq - Kimi K2 by Moonshot AI (Free)": "🌙 **Kimi K2** — Moonshot AI. Strong at long-context and agentic reasoning. Good alternative to Llama for complex IR plans.",
}
